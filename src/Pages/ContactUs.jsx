        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="bg-white rounded-lg p-6 shadow mb-10">
            ...
            <p className="mb-6 text-lg">
              Have questions, feedback, or need help finding the right roommate?
              We're here to assist you! Whether you're looking to list a room,
              search for a roommate, or need support with your account, feel
              free to reach out to us. Our team is dedicated to making your
              roommate search safe, smooth, and stress-free.summary this
              passage.
            </p>
          </div>

          <div className="bg-white rounded-lg p-6 shadow mb-10 space-y-3">
            ...
            <p className="mb-2 flex gap-3">
              ...
              <a
                href="mailto:support@roommatefind.com"
                className="text-indigo-600 underline"
              >
                support@roommatefind.com
              </a>
            </p>
