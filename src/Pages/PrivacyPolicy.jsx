  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <main className="max-w-4xl mx-auto p-6 mt-6 bg-white shadow-2xl rounded-xl">
        ...
        <p className="mb-4">
          The Roommate Finder Website values your privacy and is committed to
          protecting your personal information. Our Privacy Policy outlines how
          we collect, use, store, and share your data, such as your name,
          contact details, preferences, and location. We use this information to
          match you with compatible roommates and improve our services. Your
          data is kept secure and is never shared with third parties without
          your consent. Users have control over their profile visibility and can
          manage or delete their information at any time.
        </p>
